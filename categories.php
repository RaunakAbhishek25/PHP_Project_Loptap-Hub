<?php
// admin/manage/categories.php - Enhanced Categories Management
session_start();
...
$categories = $pdo->query("
    SELECT c.*, COUNT(l.id) as product_count 
    FROM categories c 
    LEFT JOIN laptops l ON l.category_id = c.id AND l.status = 'active' 
    GROUP BY c.id 
    ORDER BY c.name
")->fetchAll();
...
<head>
    ...
    <title>Manage Categories - LaptopHub Admin</title>
    ...
    <div class="row">
        ...
        <main class="col-md-10 ms-sm-auto px-4 main-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 animate-fade-in">
                ...
                <a href="add_category.php" class="btn btn-primary rounded-pill">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-4 animate-fade-in delay-3">
                    <div class="stat-card orange">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <div class="stat-number"><?= $total_products > 0 ? round(($total_products / count($categories))) : 0 ?></div>
                            ...
                            <?php else: ?>
                                <?php foreach ($categories as $cat): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="category-badge" style="background: <?= getCategoryColor($cat['slug']) ?>;">
                                                <i class="fas <?= getCategoryIcon($cat['slug']) ?>"></i>
                                                <?= htmlspecialchars($cat['name']) ?>
                                            </span>
                                        </td>
                                        <td><code class="text-muted"><?= htmlspecialchars($cat['slug']) ?></code></td>
                                        <td>
